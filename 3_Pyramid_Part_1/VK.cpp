/* =========================================================================
 *  Vk.cpp – single‑file Vulkan sample
 *  Shows a smoothly‑rotating 3‑D pyramid whose faces are coloured
 *  red / green / blue / yellow and whose base is cyan.
 *
 *  ↑ Major differences from your former “triangle” version
 *    ‑ Per‑vertex colour (no uniform/descriptors)
 *    ‑ Push‑constant MVP matrix updated every frame
 *    ‑ Command buffer is re‑recorded every frame so the model spins
 * ========================================================================= */
...
#include <stdbool.h>
#include <time.h>
#include <chrono>                /* animation timing */
                   ...
                   LPSTR, int iCmdShow)
{
    ...
    ghwnd=CreateWindowEx(
        ...
        TEXT("VulkanApp – Rotating Pyramid"),
