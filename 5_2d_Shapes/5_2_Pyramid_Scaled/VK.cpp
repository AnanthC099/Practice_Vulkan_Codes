 ...
 *  Depth buffer: VK_FORMAT_D32_SFLOAT via dynamic rendering.
 * ========================================================================= */
...
/* -------- depth globals -------- */
static VkFormat       vkFormat_depth  = VK_FORMAT_D32_SFLOAT;
...
static VkResult CreateGraphicsPipeline(void)
{
    ...
    pci.pDepthStencilState  = &dss;       /* NEW */
...
static VkResult recordCommandBuffer(uint32_t imgIndex,float angle)
{
    ...
    /* Barrier for depth UNDEFINED → DEPTH_ATTACHMENT_OPTIMAL */
    ...
    VkImageMemoryBarrier barriers[2]={toColor,toDepth};
...
static VkResult initialize(void)
{
    ...
    VK_CHECK(CreateSwapchain());
    VK_CHECK(CreateImagesViews());
    VK_CHECK(CreateDepthResources());      /* NEW */
    VK_CHECK(CreateCommandPoolBuffers());
